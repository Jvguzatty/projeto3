/*============================================================================*/
/* CAVERNA MARCIANA: MÓDULO DECISOR                                           */
/*----------------------------------------------------------------------------*/
/* Autores:                                                                   */
/*============================================================================*/
...
{
    // Se a memória diz que ele AINDA NÃO terminou o spawn (vale 0)
    if (d->reconhecer_spawn == 0)
    {
        if (pos.x == 0 && pos.y == 0) return (2); 
        if (pos.x == 0 && pos.y == 1) return (4); 
        if (pos.x == 1 && pos.y == 1) 
        {
    ...
    return (4); // Exemplo: segue a vida para a direita
}
